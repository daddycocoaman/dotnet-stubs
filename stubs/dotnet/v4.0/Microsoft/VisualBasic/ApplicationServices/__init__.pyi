...
class StartupNextInstanceEventArgs:
    ...
    def BringToForeground(self, value: bool) -> None: ...
...
class UnhandledExceptionEventArgs:
    ...
    def ExitApplication(self, value: bool) -> None: ...
...
class User:
    ...
    @property
    def Name(self) -> str: ...
    def InitializeWithWindowsUser(self) -> None: ...
    @overload
    def IsInRole(self, role: str) -> bool: ...
    @overload
    def IsInRole(self, role: BuiltInRole) -> bool: ...
