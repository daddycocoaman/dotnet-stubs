...
class Ports:
    ...
    @overload
    def OpenSerialPort(self, portName: str) -> SerialPort: ...
    @overload
    def OpenSerialPort(self, portName: str, baudRate: int) -> SerialPort: ...
    @overload
    def OpenSerialPort(self, portName: str, baudRate: int, parity: Parity) -> SerialPort: ...
    @overload
    def OpenSerialPort(self, portName: str, baudRate: int, parity: Parity, dataBits: int) -> SerialPort: ...
    @overload
