...
class FlowControl:
    def CheckForSyncLockOnValueType(obj: Object) -> None: ...
    def ForEachInArr(ary: Array) -> IEnumerator: ...
    def ForEachInObj(obj: Object) -> IEnumerator: ...
    def ForEachNextObj(obj: Object, enumerator: IEnumerator) -> Tuple[bool, Object]: ...
...
class InternalXmlHelper:
    ...
    @property
    def AttributeValue(source: Iterable[XElement], name: XName) -> str: ...
    @property
    def AttributeValue(source: XElement, name: XName) -> str: ...
    @property
    def Value(source: Iterable[XElement]) -> str: ...
    @overload
    def RemoveNamespaceAttributes(inScopePrefixes: Set(str), inScopeNs: Set(XNamespace), attributes: List, obj: Object) -> Object: ...
    @overload
    def RemoveNamespaceAttributes(inScopePrefixes: Set(str), inScopeNs: Set(XNamespace), attributes: List, obj: IEnumerable) -> IEnumerable: ...
    @overload
    def RemoveNamespaceAttributes(inScopePrefixes: Set(str), inScopeNs: Set(XNamespace), attributes: List, e: XElement) -> XElement: ...
    @AttributeValue.setter
    def AttributeValue(source: Iterable[XElement], name: XName, value: str) -> None: ...
    @AttributeValue.setter
    def AttributeValue(source: XElement, name: XName, value: str) -> None: ...
    @Value.setter
    def Value(source: Iterable[XElement], value: str) -> None: ...
...
class NewLateBinding:
    ...
    def LateCanEvaluate(instance: Object, type: Type, memberName: str, arguments: Set(Object), allowFunctionEvaluation: bool, allowPropertyEvaluation: bool) -> bool: ...
...
class Utils:
    ...
    def ThrowException(hr: int) -> None: ...
