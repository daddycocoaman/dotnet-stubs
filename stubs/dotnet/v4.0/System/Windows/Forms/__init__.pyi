...
class ContextMenu(Menu):
    ...
    def __init__(self): ...
    @overload
    def __init__(self, menuItems: Set(MenuItem)): ...
    def add_Collapse(self, value: EventHandler) -> None: ...
    def add_Popup(self, value: EventHandler) -> None: ...
    @property
    def RightToLeft(self) -> RightToLeft: ...
    @property
    def SourceControl(self) -> Control: ...
    def remove_Collapse(self, value: EventHandler) -> None: ...
    def remove_Popup(self, value: EventHandler) -> None: ...
    @RightToLeft.setter
    def RightToLeft(self, value: RightToLeft) -> None: ...
    @overload
    def Show(self, control: Control, pos: Point) -> None: ...
    @overload
    def Show(self, control: Control, pos: Point, alignment: LeftRightAlignment) -> None: ...
...
class DataGrid(Control):
    def __init__(self): ...
    def add_AllowNavigationChanged(self, value: EventHandler) -> None: ...
    def add_BackButtonClick(self, value: EventHandler) -> None: ...
    ...
    def add_CaptionVisibleChanged(self, value: EventHandler) -> None: ...
    def add_CurrentCellChanged(self, value: EventHandler) -> None: ...
    @overload
    def add_CursorChanged(self, value: EventHandler) -> None: ...
    def add_DataSourceChanged(self, value: EventHandler) -> None: ...
    def add_FlatModeChanged(self, value: EventHandler) -> None: ...
    def add_Navigate(self, value: NavigateEventHandler) -> None: ...
    def add_ParentRowsLabelStyleChanged(self, value: EventHandler) -> None: ...
    def add_ParentRowsVisibleChanged(self, value: EventHandler) -> None: ...
    def add_ReadOnlyChanged(self, value: EventHandler) -> None: ...
    def add_Scroll(self, value: EventHandler) -> None: ...
    def add_ShowParentDetailsButtonClick(self, value: EventHandler) -> None: ...
    @overload
    def add_TextChanged(self, value: EventHandler) -> None: ...
    def BeginEdit(self, gridColumn: DataGridColumnStyle, rowNumber: int) -> bool: ...
    def BeginInit(self) -> None: ...
    def Collapse(self, row: int) -> None: ...
    def EndEdit(self, gridColumn: DataGridColumnStyle, rowNumber: int, shouldAbort: bool) -> bool: ...
    def EndInit(self) -> None: ...
    ...
    @property
    def Item(self, cell: DataGridCell) -> Object: ...
    @property
    def Item(self, rowIndex: int, columnIndex: int) -> Object: ...
    @property
    ...
    @overload
    def GetCellBounds(self, dgc: DataGridCell) -> Rectangle: ...
    @overload
    def GetCellBounds(self, row: int, col: int) -> Rectangle: ...
    def GetCurrentCellBounds(self) -> Rectangle: ...
    @overload
    def HitTest(self, position: Point) -> HitTestInfo: ...
    @overload
    ...
    def NavigateTo(self, rowNumber: int, relationName: str) -> None: ...
    def remove_AllowNavigationChanged(self, value: EventHandler) -> None: ...
    def remove_BackButtonClick(self, value: EventHandler) -> None: ...
    ...
    def remove_CaptionVisibleChanged(self, value: EventHandler) -> None: ...
    def remove_CurrentCellChanged(self, value: EventHandler) -> None: ...
    @overload
    def remove_CursorChanged(self, value: EventHandler) -> None: ...
    def remove_DataSourceChanged(self, value: EventHandler) -> None: ...
    def remove_FlatModeChanged(self, value: EventHandler) -> None: ...
    def remove_Navigate(self, value: NavigateEventHandler) -> None: ...
    def remove_ParentRowsLabelStyleChanged(self, value: EventHandler) -> None: ...
    def remove_ParentRowsVisibleChanged(self, value: EventHandler) -> None: ...
    def remove_ReadOnlyChanged(self, value: EventHandler) -> None: ...
    def remove_Scroll(self, value: EventHandler) -> None: ...
    def remove_ShowParentDetailsButtonClick(self, value: EventHandler) -> None: ...
    @overload
    def remove_TextChanged(self, value: EventHandler) -> None: ...
    def ResetAlternatingBackColor(self) -> None: ...
    def ResetBackColor(self) -> None: ...
    def ResetForeColor(self) -> None: ...
    def ResetGridLineColor(self) -> None: ...
    def ResetHeaderBackColor(self) -> None: ...
    def ResetHeaderFont(self) -> None: ...
    def ResetHeaderForeColor(self) -> None: ...
    def ResetLinkColor(self) -> None: ...
    def ResetLinkHoverColor(self) -> None: ...
    def ResetSelectionBackColor(self) -> None: ...
    def ResetSelectionForeColor(self) -> None: ...
    @overload
    def Select(self, row: int) -> None: ...
    @AllowNavigation.setter
    def AllowNavigation(self, value: bool) -> None: ...
    @AllowSorting.setter
    def AllowSorting(self, value: bool) -> None: ...
    @AlternatingBackColor.setter
    def AlternatingBackColor(self, value: Color) -> None: ...
    @BackColor.setter
    def BackColor(self, value: Color) -> None: ...
    ...
    @CaptionBackColor.setter
    def CaptionBackColor(self, value: Color) -> None: ...
    @CaptionFont.setter
    def CaptionFont(self, value: Font) -> None: ...
    @CaptionForeColor.setter
    def CaptionForeColor(self, value: Color) -> None: ...
    @CaptionText.setter
    def CaptionText(self, value: str) -> None: ...
    @CaptionVisible.setter
    def CaptionVisible(self, value: bool) -> None: ...
    @ColumnHeadersVisible.setter
    def ColumnHeadersVisible(self, value: bool) -> None: ...
    @CurrentCell.setter
    def CurrentCell(self, value: DataGridCell) -> None: ...
    @CurrentRowIndex.setter
    def CurrentRowIndex(self, value: int) -> None: ...
    @Cursor.setter
    def Cursor(self, value: Cursor) -> None: ...
    @DataMember.setter
    def DataMember(self, value: str) -> None: ...
    ...
    def DataSource(self, value: Object) -> None: ...
    @FlatMode.setter
    def FlatMode(self, value: bool) -> None: ...
    @ForeColor.setter
    def ForeColor(self, value: Color) -> None: ...
    @GridLineColor.setter
    def GridLineColor(self, value: Color) -> None: ...
    @GridLineStyle.setter
    def GridLineStyle(self, value: DataGridLineStyle) -> None: ...
    ...
    @Item.setter
    def Item(self, cell: DataGridCell, value: Object) -> None: ...
    @Item.setter
    def Item(self, rowIndex: int, columnIndex: int, value: Object) -> None: ...
    @LinkColor.setter
    def LinkColor(self, value: Color) -> None: ...
    @LinkHoverColor.setter
    def LinkHoverColor(self, value: Color) -> None: ...
    @ParentRowsBackColor.setter
    def ParentRowsBackColor(self, value: Color) -> None: ...
    @ParentRowsForeColor.setter
    def ParentRowsForeColor(self, value: Color) -> None: ...
    @ParentRowsLabelStyle.setter
    def ParentRowsLabelStyle(self, value: DataGridParentRowsLabelStyle) -> None: ...
    @ParentRowsVisible.setter
    def ParentRowsVisible(self, value: bool) -> None: ...
    @PreferredColumnWidth.setter
    def PreferredColumnWidth(self, value: int) -> None: ...
    @PreferredRowHeight.setter
    def PreferredRowHeight(self, value: int) -> None: ...
    @ReadOnly.setter
    ...
    @Text.setter
    def Text(self, value: str) -> None: ...
    def SetDataBinding(self, dataSource: Object, dataMember: str) -> None: ...
    def SubObjectsSiteChange(self, site: bool) -> None: ...
    def UnSelect(self, row: int) -> None: ...


class DataGridBoolColumn(DataGridColumnStyle):
    @overload
    def __init__(self): ...
    @overload
    def __init__(self, prop: PropertyDescriptor): ...
    @overload
    def __init__(self, prop: PropertyDescriptor, isDefault: bool): ...
    def add_AllowNullChanged(self, value: EventHandler) -> None: ...
    def add_FalseValueChanged(self, value: EventHandler) -> None: ...
    def add_TrueValueChanged(self, value: EventHandler) -> None: ...
    @property
    ...
    def remove_AllowNullChanged(self, value: EventHandler) -> None: ...
    def remove_FalseValueChanged(self, value: EventHandler) -> None: ...
    def remove_TrueValueChanged(self, value: EventHandler) -> None: ...
    @AllowNull.setter
...
class DataGridColumnStyle(Component):
    @overload
    def __init__(self): ...
    @overload
    def __init__(self, prop: PropertyDescriptor): ...
    def add_AlignmentChanged(self, value: EventHandler) -> None: ...
    def add_FontChanged(self, value: EventHandler) -> None: ...
    def add_HeaderTextChanged(self, value: EventHandler) -> None: ...
    def add_MappingNameChanged(self, value: EventHandler) -> None: ...
    def add_NullTextChanged(self, value: EventHandler) -> None: ...
    def add_PropertyDescriptorChanged(self, value: EventHandler) -> None: ...
    def add_ReadOnlyChanged(self, value: EventHandler) -> None: ...
    def add_WidthChanged(self, value: EventHandler) -> None: ...
    @property
    ...
    @property
    def Width(self) -> int: ...
    def remove_AlignmentChanged(self, value: EventHandler) -> None: ...
    def remove_FontChanged(self, value: EventHandler) -> None: ...
    def remove_HeaderTextChanged(self, value: EventHandler) -> None: ...
    def remove_MappingNameChanged(self, value: EventHandler) -> None: ...
    def remove_NullTextChanged(self, value: EventHandler) -> None: ...
    def remove_PropertyDescriptorChanged(self, value: EventHandler) -> None: ...
    def remove_ReadOnlyChanged(self, value: EventHandler) -> None: ...
    def remove_WidthChanged(self, value: EventHandler) -> None: ...
    def ResetHeaderText(self) -> None: ...
    @Alignment.setter
    def Alignment(self, value: HorizontalAlignment) -> None: ...
    @HeaderText.setter
    def HeaderText(self, value: str) -> None: ...
    @MappingName.setter
    def MappingName(self, value: str) -> None: ...
    @NullText.setter
    def NullText(self, value: str) -> None: ...
...
class DataGridTableStyle(Component):
    @overload
    def __init__(self): ...
    @overload
    def __init__(self, isDefaultTableStyle: bool): ...
    @overload
    def __init__(self, listManager: CurrencyManager): ...
    def add_AllowSortingChanged(self, value: EventHandler) -> None: ...
    def add_AlternatingBackColorChanged(self, value: EventHandler) -> None: ...
    def add_BackColorChanged(self, value: EventHandler) -> None: ...
    def add_ColumnHeadersVisibleChanged(self, value: EventHandler) -> None: ...
    def add_ForeColorChanged(self, value: EventHandler) -> None: ...
    def add_GridLineColorChanged(self, value: EventHandler) -> None: ...
    def add_GridLineStyleChanged(self, value: EventHandler) -> None: ...
    def add_HeaderBackColorChanged(self, value: EventHandler) -> None: ...
    def add_HeaderFontChanged(self, value: EventHandler) -> None: ...
    def add_HeaderForeColorChanged(self, value: EventHandler) -> None: ...
    def add_LinkColorChanged(self, value: EventHandler) -> None: ...
    def add_LinkHoverColorChanged(self, value: EventHandler) -> None: ...
    def add_MappingNameChanged(self, value: EventHandler) -> None: ...
    def add_PreferredColumnWidthChanged(self, value: EventHandler) -> None: ...
    def add_PreferredRowHeightChanged(self, value: EventHandler) -> None: ...
    def add_ReadOnlyChanged(self, value: EventHandler) -> None: ...
    def add_RowHeadersVisibleChanged(self, value: EventHandler) -> None: ...
    def add_RowHeaderWidthChanged(self, value: EventHandler) -> None: ...
    def add_SelectionBackColorChanged(self, value: EventHandler) -> None: ...
    def add_SelectionForeColorChanged(self, value: EventHandler) -> None: ...
    def BeginEdit(self, gridColumn: DataGridColumnStyle, rowNumber: int) -> bool: ...
    def EndEdit(self, gridColumn: DataGridColumnStyle, rowNumber: int, shouldAbort: bool) -> bool: ...
    @property
    def AllowSorting(self) -> bool: ...
    ...
    @property
    def SelectionForeColor(self) -> Color: ...
    def remove_AllowSortingChanged(self, value: EventHandler) -> None: ...
    def remove_AlternatingBackColorChanged(self, value: EventHandler) -> None: ...
    def remove_BackColorChanged(self, value: EventHandler) -> None: ...
    def remove_ColumnHeadersVisibleChanged(self, value: EventHandler) -> None: ...
    def remove_ForeColorChanged(self, value: EventHandler) -> None: ...
    def remove_GridLineColorChanged(self, value: EventHandler) -> None: ...
    def remove_GridLineStyleChanged(self, value: EventHandler) -> None: ...
    def remove_HeaderBackColorChanged(self, value: EventHandler) -> None: ...
    def remove_HeaderFontChanged(self, value: EventHandler) -> None: ...
    def remove_HeaderForeColorChanged(self, value: EventHandler) -> None: ...
    def remove_LinkColorChanged(self, value: EventHandler) -> None: ...
    def remove_LinkHoverColorChanged(self, value: EventHandler) -> None: ...
    def remove_MappingNameChanged(self, value: EventHandler) -> None: ...
    def remove_PreferredColumnWidthChanged(self, value: EventHandler) -> None: ...
    def remove_PreferredRowHeightChanged(self, value: EventHandler) -> None: ...
    def remove_ReadOnlyChanged(self, value: EventHandler) -> None: ...
    def remove_RowHeadersVisibleChanged(self, value: EventHandler) -> None: ...
    def remove_RowHeaderWidthChanged(self, value: EventHandler) -> None: ...
    def remove_SelectionBackColorChanged(self, value: EventHandler) -> None: ...
    def remove_SelectionForeColorChanged(self, value: EventHandler) -> None: ...
    def ResetAlternatingBackColor(self) -> None: ...
    def ResetBackColor(self) -> None: ...
    def ResetForeColor(self) -> None: ...
    def ResetGridLineColor(self) -> None: ...
    ...
    def ColumnHeadersVisible(self, value: bool) -> None: ...
    @DataGrid.setter
    def DataGrid(self, value: DataGrid) -> None: ...
    @ForeColor.setter
    def ForeColor(self, value: Color) -> None: ...
    @GridLineColor.setter
    def GridLineColor(self, value: Color) -> None: ...
...
class DataGridTextBox(TextBox):
    def __init__(self): ...
    @property
    def IsInEditOrNavigateMode(self) -> bool: ...
    @IsInEditOrNavigateMode.setter
    def IsInEditOrNavigateMode(self, value: bool) -> None: ...
    def SetDataGrid(self, parentGrid: DataGrid) -> None: ...


class DataGridTextBoxColumn(DataGridColumnStyle):
    @overload
    def __init__(self): ...
    @overload
    def __init__(self, prop: PropertyDescriptor): ...
    @overload
    def __init__(self, prop: PropertyDescriptor, format: str): ...
    @overload
    def __init__(self, prop: PropertyDescriptor, isDefault: bool): ...
    @overload
    def __init__(self, prop: PropertyDescriptor, format: str, isDefault: bool): ...
    @property
    def Format(self) -> str: ...
    @property
    def FormatInfo(self) -> IFormatProvider: ...
...
class GridColumnStylesCollection(BaseCollection):
    def add_CollectionChanged(self, value: CollectionChangeEventHandler) -> None: ...
    def Add(self, column: DataGridColumnStyle) -> int: ...
    def AddRange(self, columns: Set(DataGridColumnStyle)) -> None: ...
    def Clear(self) -> None: ...
    @overload
    def Contains(self, propertyDescriptor: PropertyDescriptor) -> bool: ...
    @overload
    def Contains(self, column: DataGridColumnStyle) -> bool: ...
    @overload
    def Contains(self, name: str) -> bool: ...
    @property
    def Item(self, index: int) -> DataGridColumnStyle: ...
    @property
    def Item(self, propertyDesciptor: PropertyDescriptor) -> DataGridColumnStyle: ...
    @property
    def Item(self, columnName: str) -> DataGridColumnStyle: ...
    def IndexOf(self, element: DataGridColumnStyle) -> int: ...
    def remove_CollectionChanged(self, value: CollectionChangeEventHandler) -> None: ...
    def Remove(self, column: DataGridColumnStyle) -> None: ...
    def RemoveAt(self, index: int) -> None: ...
    def ResetPropertyDescriptors(self) -> None: ...
...
class GridTablesFactory(Object):
    def CreateGridTables(gridTable: DataGridTableStyle, dataSource: Object, dataMember: str, bindingManager: BindingContext) -> Set(DataGridTableStyle): ...


class GridTableStylesCollection(BaseCollection):
    def add_CollectionChanged(self, value: CollectionChangeEventHandler) -> None: ...
    def Add(self, table: DataGridTableStyle) -> int: ...
    def AddRange(self, tables: Set(DataGridTableStyle)) -> None: ...
    def Clear(self) -> None: ...
    @overload
    def Contains(self, table: DataGridTableStyle) -> bool: ...
    @overload
    def Contains(self, name: str) -> bool: ...
    @property
    def Item(self, index: int) -> DataGridTableStyle: ...
    @property
    def Item(self, tableName: str) -> DataGridTableStyle: ...
    def remove_CollectionChanged(self, value: CollectionChangeEventHandler) -> None: ...
    def Remove(self, table: DataGridTableStyle) -> None: ...
    def RemoveAt(self, index: int) -> None: ...
...
class Menu(Component):
    ...
    def MergeMenu(self, menuSrc: Menu) -> None: ...
    @Name.setter
    def Name(self, value: str) -> None: ...
    @Tag.setter
    def Tag(self, value: Object) -> None: ...
...
class MenuItem(Menu):
    ...
    def __init__(self, text: str): ...
    @overload
    def __init__(self, text: str, onClick: EventHandler): ...
    @overload
    def __init__(self, text: str, items: Set(MenuItem)): ...
    @overload
    def __init__(self, text: str, onClick: EventHandler, shortcut: Shortcut): ...
    @overload
    def __init__(self, mergeType: MenuMerge, mergeOrder: int, shortcut: Shortcut, text: str, onClick: EventHandler, onPopup: EventHandler, onSelect: EventHandler, items: Set(MenuItem)): ...
    def add_Click(self, value: EventHandler) -> None: ...
    def add_DrawItem(self, value: DrawItemEventHandler) -> None: ...
    def add_MeasureItem(self, value: MeasureItemEventHandler) -> None: ...
    def add_Popup(self, value: EventHandler) -> None: ...
    def add_Select(self, value: EventHandler) -> None: ...
    def CloneMenu(self) -> MenuItem: ...
    @property
    ...
    def Visible(self) -> bool: ...
    @overload
    def MergeMenu(self) -> MenuItem: ...
    @overload
    def MergeMenu(self, itemSrc: MenuItem) -> None: ...
    def PerformClick(self) -> None: ...
    def PerformSelect(self) -> None: ...
    def remove_Click(self, value: EventHandler) -> None: ...
    def remove_DrawItem(self, value: DrawItemEventHandler) -> None: ...
    def remove_MeasureItem(self, value: MeasureItemEventHandler) -> None: ...
    def remove_Popup(self, value: EventHandler) -> None: ...
    def remove_Select(self, value: EventHandler) -> None: ...
    @BarBreak.setter
    def BarBreak(self, value: bool) -> None: ...
    @Break.setter
    def Break(self, value: bool) -> None: ...
    @Checked.setter
    def Checked(self, value: bool) -> None: ...
    @DefaultItem.setter
    def DefaultItem(self, value: bool) -> None: ...
    @Enabled.setter
    def Enabled(self, value: bool) -> None: ...
    @Index.setter
    def Index(self, value: int) -> None: ...
    @MdiList.setter
    def MdiList(self, value: bool) -> None: ...
    @MergeOrder.setter
    def MergeOrder(self, value: int) -> None: ...
    @MergeType.setter
    def MergeType(self, value: MenuMerge) -> None: ...
    @OwnerDraw.setter
    def OwnerDraw(self, value: bool) -> None: ...
    @RadioCheck.setter
    def RadioCheck(self, value: bool) -> None: ...
    @Shortcut.setter
    def Shortcut(self, value: Shortcut) -> None: ...
    @ShowShortcut.setter
    def ShowShortcut(self, value: bool) -> None: ...
    @Text.setter
    def Text(self, value: str) -> None: ...
    @Visible.setter
    def Visible(self, value: bool) -> None: ...
...
class MenuItemCollection(Object):
    ...
    @overload
    def Add(self, caption: str) -> MenuItem: ...
    @overload
    def Add(self, item: MenuItem) -> int: ...
    @overload
    def Add(self, index: int, item: MenuItem) -> int: ...
    @overload
    def Add(self, caption: str, onClick: EventHandler) -> MenuItem: ...
    @overload
    def Add(self, caption: str, items: Set(MenuItem)) -> MenuItem: ...
    def AddRange(self, items: Set(MenuItem)) -> None: ...
    def Clear(self) -> None: ...
    def Contains(self, value: MenuItem) -> bool: ...
    def ContainsKey(self, key: str) -> bool: ...
    def CopyTo(self, dest: Array, index: int) -> None: ...
    def Find(self, key: str, searchAllChildren: bool) -> Set(MenuItem): ...
    @property
    def Count(self) -> int: ...
    @property
    def IsReadOnly(self) -> bool: ...
    ...
    @property
    def Item(self, index: int) -> MenuItem: ...
    def GetEnumerator(self) -> IEnumerator: ...
...
class ToolBar(Control):
    ...
    @overload
    def add_BackgroundImageLayoutChanged(self, value: EventHandler) -> None: ...
    def add_ButtonClick(self, value: ToolBarButtonClickEventHandler) -> None: ...
    def add_ButtonDropDown(self, value: ToolBarButtonClickEventHandler) -> None: ...
    @overload
    def add_ForeColorChanged(self, value: EventHandler) -> None: ...
    @overload
    def add_ImeModeChanged(self, value: EventHandler) -> None: ...
    ...
    @overload
    def remove_BackgroundImageLayoutChanged(self, value: EventHandler) -> None: ...
    def remove_ButtonClick(self, value: ToolBarButtonClickEventHandler) -> None: ...
    def remove_ButtonDropDown(self, value: ToolBarButtonClickEventHandler) -> None: ...
    @overload
    def remove_ForeColorChanged(self, value: EventHandler) -> None: ...
    @overload
    def remove_ImeModeChanged(self, value: EventHandler) -> None: ...
    ...
    def remove_TextChanged(self, value: EventHandler) -> None: ...
    @Appearance.setter
    def Appearance(self, value: ToolBarAppearance) -> None: ...
    @AutoSize.setter
    def AutoSize(self, value: bool) -> None: ...
    @BackColor.setter
    def BackColor(self, value: Color) -> None: ...
    ...
    def BorderStyle(self, value: BorderStyle) -> None: ...
    @ButtonSize.setter
    def ButtonSize(self, value: Size) -> None: ...
    @Divider.setter
    def Divider(self, value: bool) -> None: ...
    @Dock.setter
    def Dock(self, value: DockStyle) -> None: ...
    @DropDownArrows.setter
    def DropDownArrows(self, value: bool) -> None: ...
    @ForeColor.setter
    def ForeColor(self, value: Color) -> None: ...
    @ImageList.setter
    def ImageList(self, value: ImageList) -> None: ...
    ...
    @Wrappable.setter
    def Wrappable(self, value: bool) -> None: ...
    def ToString(self) -> str: ...
...
class ToolBarButton(Component):
    ...
    def Name(self, value: str) -> None: ...
    @PartialPush.setter
    def PartialPush(self, value: bool) -> None: ...
    @Pushed.setter
    def Pushed(self, value: bool) -> None: ...
    @Style.setter
    def Style(self, value: ToolBarButtonStyle) -> None: ...
    @Tag.setter
    def Tag(self, value: Object) -> None: ...
    @Text.setter
    def Text(self, value: str) -> None: ...
...
class ToolBarButtonClickEventArgs(EventArgs):
    def __init__(self, button: ToolBarButton): ...
    @property
    def Button(self) -> ToolBarButton: ...
    @Button.setter
    def Button(self, value: ToolBarButton) -> None: ...


class ToolBarButtonClickEventHandler(MulticastDelegate):
    def __init__(self, object: Object, method: IntPtr): ...
    def BeginInvoke(self, sender: Object, e: ToolBarButtonClickEventArgs, callback: AsyncCallback, object: Object) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
    def Invoke(self, sender: Object, e: ToolBarButtonClickEventArgs) -> None: ...


class ToolBarButtonCollection(Object):
    def __init__(self, owner: ToolBar): ...
    @overload
    def Add(self, button: ToolBarButton) -> int: ...
    @overload
    def Add(self, text: str) -> int: ...
    def AddRange(self, buttons: Set(ToolBarButton)) -> None: ...
    def Clear(self) -> None: ...
    def Contains(self, button: ToolBarButton) -> bool: ...
    def ContainsKey(self, key: str) -> bool: ...
    @property
    def Count(self) -> int: ...
    @property
    def IsReadOnly(self) -> bool: ...
    @property
    def Item(self, key: str) -> ToolBarButton: ...
    @property
    def Item(self, index: int) -> ToolBarButton: ...
    def GetEnumerator(self) -> IEnumerator: ...
    def IndexOf(self, button: ToolBarButton) -> int: ...
    def IndexOfKey(self, key: str) -> int: ...
    def Insert(self, index: int, button: ToolBarButton) -> None: ...
    def Remove(self, button: ToolBarButton) -> None: ...
    def RemoveAt(self, index: int) -> None: ...
    def RemoveByKey(self, key: str) -> None: ...
    @Item.setter
    def Item(self, index: int, value: ToolBarButton) -> None: ...
