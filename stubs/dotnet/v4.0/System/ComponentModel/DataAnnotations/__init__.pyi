...
class AssociationAttribute(Attribute):
    def __init__(self, name: str, thisKey: str, otherKey: str): ...
    @property
    ...
    @property
    def OtherKeyMembers(self) -> Iterable[str]: ...
    @property
    def ThisKey(self) -> str: ...
    @property
    def ThisKeyMembers(self) -> Iterable[str]: ...
    @IsForeignKey.setter
    def IsForeignKey(self, value: bool) -> None: ...


class BindableTypeAttribute(Attribute):
    def __init__(self): ...
    @property
    def IsBindable(self) -> bool: ...
    @IsBindable.setter
    def IsBindable(self, value: bool) -> None: ...
...
class FilterUIHintAttribute(Attribute):
    @overload
    def __init__(self, filterUIHint: str): ...
    @overload
    def __init__(self, filterUIHint: str, presentationLayer: str): ...
    @overload
    def __init__(self, filterUIHint: str, presentationLayer: str, controlParameters: Set(Object)): ...
...
class ScaffoldTableAttribute(Attribute):
    def __init__(self, scaffold: bool): ...
    @property
    def Scaffold(self) -> bool: ...
