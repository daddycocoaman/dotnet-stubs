...
class IComponentDesignerDebugService:
    def Assert(self, condition: bool, message: str) -> None: ...
...
class IComponentDesignerStateService:
    def GetState(self, component: IComponent, key: str) -> Object: ...
    def SetState(self, component: IComponent, key: str, value: Object) -> None: ...


class IDesignTimeAssemblyLoader:
