...
class Annotation(ChartNamedElement):
    ...
    @property
    def MapAreaAttributes(self) -> str: ...
    @property
    def Name(self) -> str: ...
    @property
    ...
    @MapAreaAttributes.setter
    def MapAreaAttributes(self, value: str) -> None: ...
    @Name.setter
    def Name(self, value: str) -> None: ...
    @PostBackValue.setter
    def PostBackValue(self, value: str) -> None: ...
    @Right.setter
...
class Chart(DataBoundControl):
    def __init__(self): ...
    def add_Click(self, value: ImageMapEventHandler) -> None: ...
    def add_Customize(self, value: EventHandler) -> None: ...
    def add_CustomizeLegend(self, value: EventHandler) -> None: ...
    def add_CustomizeMapAreas(self, value: EventHandler) -> None: ...
    ...
    @property
    def CurrentImageLocation(self) -> str: ...
    @property
    ...
    @property
    def ImageStorageMode(self) -> ImageStorageMode: ...
    @property
    def ImageType(self) -> ChartImageType: ...
    @property
    def IsMapAreaAttributesEncoded(self) -> bool: ...
    @property
    def IsMapEnabled(self) -> bool: ...
    @property
    def IsSoftShadows(self) -> bool: ...
    @property
    def Legends(self) -> LegendCollection: ...
    @property
    def MapAreas(self) -> MapAreasCollection: ...
    @property
    ...
    @property
    def ViewStateContent(self) -> SerializationContents: ...
    @property
    def ViewStateData(self) -> str: ...
    @property
    def Width(self) -> Unit: ...
    def GetChartElementOutline(self, chartElement: Object, elementType: ChartElementType) -> ChartElementOutline: ...
    def GetHtmlImageMap(self, name: str) -> str: ...
    ...
    def Paint(self, graphics: Graphics, position: Rectangle) -> None: ...
    def remove_Click(self, value: ImageMapEventHandler) -> None: ...
    def remove_Customize(self, value: EventHandler) -> None: ...
    def remove_CustomizeLegend(self, value: EventHandler) -> None: ...
    def remove_CustomizeMapAreas(self, value: EventHandler) -> None: ...
    ...
    @overload
    def SaveImage(self, imageFileName: str) -> None: ...
    @overload
    def SaveImage(self, imageStream: Stream) -> None: ...
    @overload
    ...
    def SaveXml(self, name: str) -> None: ...
    ...
    def DescriptionUrl(self, value: str) -> None: ...
    @EnableViewState.setter
    def EnableViewState(self, value: bool) -> None: ...
    @ForeColor.setter
    def ForeColor(self, value: Color) -> None: ...
    @Height.setter
    ...
    @ImageStorageMode.setter
    def ImageStorageMode(self, value: ImageStorageMode) -> None: ...
    @ImageType.setter
    def ImageType(self, value: ChartImageType) -> None: ...
    @IsMapAreaAttributesEncoded.setter
    def IsMapAreaAttributesEncoded(self, value: bool) -> None: ...
    @IsMapEnabled.setter
    def IsMapEnabled(self, value: bool) -> None: ...
    ...
    @RenderType.setter
    def RenderType(self, value: RenderType) -> None: ...
    @RightToLeft.setter
    ...
    @ViewStateContent.setter
    def ViewStateContent(self, value: SerializationContents) -> None: ...
    @ViewStateData.setter
    def ViewStateData(self, value: str) -> None: ...
    @Width.setter
...
class ChartHttpHandler(Page):
    def __init__(self): ...
    @property
    def Settings() -> ChartHttpHandlerSettings: ...
...
class ChartHttpHandlerStorageType:
    InProcess = 0
    File = 1
    Session = 2
...
class CustomizeMapAreasEventArgs(EventArgs):
    def __init__(self, areaItems: MapAreasCollection): ...
    @property
    def MapAreaItems(self) -> MapAreasCollection: ...
...
class CustomLabel(ChartNamedElement):
    ...
    def Image(self) -> str: ...
    @property
    def ImageMapAreaAttributes(self) -> str: ...
    @property
    def ImagePostBackValue(self) -> str: ...
    @property
    ...
    @ImageMapAreaAttributes.setter
    def ImageMapAreaAttributes(self, value: str) -> None: ...
    @ImagePostBackValue.setter
    def ImagePostBackValue(self, value: str) -> None: ...
...
class DataPointCustomProperties(ChartNamedElement):
    ...
    @property
    def LabelMapAreaAttributes(self) -> str: ...
    @property
    def LabelPostBackValue(self) -> str: ...
    @property
    def LabelToolTip(self) -> str: ...
    @property
    def LabelUrl(self) -> str: ...
    @property
    def LegendMapAreaAttributes(self) -> str: ...
    @property
    def LegendPostBackValue(self) -> str: ...
    @property
    ...
    @LabelMapAreaAttributes.setter
    def LabelMapAreaAttributes(self, value: str) -> None: ...
    @LabelPostBackValue.setter
    def LabelPostBackValue(self, value: str) -> None: ...
    @LabelToolTip.setter
    def LabelToolTip(self, value: str) -> None: ...
    @LabelUrl.setter
    def LabelUrl(self, value: str) -> None: ...
    @LegendMapAreaAttributes.setter
    def LegendMapAreaAttributes(self, value: str) -> None: ...
    @LegendPostBackValue.setter
    def LegendPostBackValue(self, value: str) -> None: ...
    @LegendText.setter
    def LegendText(self, value: str) -> None: ...
    @LegendToolTip.setter
    def LegendToolTip(self, value: str) -> None: ...
    @LegendUrl.setter
    def LegendUrl(self, value: str) -> None: ...
    @MapAreaAttributes.setter
    def MapAreaAttributes(self, value: str) -> None: ...
...
class IChartStorageHandler:
    def Delete(self, key: str) -> None: ...
    def Exists(self, key: str) -> bool: ...
    def Load(self, key: str) -> Set(Byte): ...
    def Save(self, key: str, data: Set(Byte)) -> None: ...
...
class MapArea(ChartNamedElement):
    @overload
    def __init__(self): ...
    @overload
    def __init__(self, url: str, path: GraphicsPath): ...
    @overload
    def __init__(self, url: str, rect: RectangleF): ...
    @overload
    def __init__(self, shape: MapAreaShape, url: str, coordinates: Set(Single)): ...
    @overload
    def __init__(self, toolTip: str, url: str, attributes: str, postBackValue: str, path: GraphicsPath, tag: Object): ...
    @overload
    def __init__(self, toolTip: str, url: str, attributes: str, postBackValue: str, rect: RectangleF, tag: Object): ...
    @overload
    def __init__(self, shape: MapAreaShape, toolTip: str, url: str, attributes: str, postBackValue: str, coordinates: Set(Single), tag: Object): ...
    @property
    def Coordinates(self) -> Set(Single): ...
    @property
    ...
    def PostBackValue(self) -> str: ...
    @property
    def Shape(self) -> MapAreaShape: ...
    @property
    def ToolTip(self) -> str: ...
    @property
    def Url(self) -> str: ...
    @Coordinates.setter
    def Coordinates(self, value: Set(Single)) -> None: ...
    @MapAreaAttributes.setter
    def MapAreaAttributes(self, value: str) -> None: ...
    @Name.setter
    def Name(self, value: str) -> None: ...
    ...
    def PostBackValue(self, value: str) -> None: ...
    @Shape.setter
    def Shape(self, value: MapAreaShape) -> None: ...
    @ToolTip.setter
    def ToolTip(self, value: str) -> None: ...
    @Url.setter
    def Url(self, value: str) -> None: ...
