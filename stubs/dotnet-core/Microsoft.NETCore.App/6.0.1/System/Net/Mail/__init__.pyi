...
class MailAddress(Object):
    ...
    @overload
    def TryCreate(address: str) -> Tuple[bool, MailAddress]: ...
    @overload
    def TryCreate(address: str, displayName: str) -> Tuple[bool, MailAddress]: ...
    @overload
    def TryCreate(address: str, displayName: str, displayNameEncoding: Encoding) -> Tuple[bool, MailAddress]: ...
