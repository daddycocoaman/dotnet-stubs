...
class HeaderStringValues(ValueType):
    @property
    def Count(self) -> int: ...
...
class HttpHeadersNonValidated(ValueType):
    def Contains(self, headerName: str) -> bool: ...
    @property
    def Count(self) -> int: ...
    @property
    def Item(self, headerName: str) -> HeaderStringValues: ...
    def GetEnumerator(self) -> Enumerator: ...
    def TryGetValues(self, headerName: str) -> Tuple[bool, HeaderStringValues]: ...
