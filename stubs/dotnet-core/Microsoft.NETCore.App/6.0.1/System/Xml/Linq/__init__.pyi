...
class XDocument(XContainer):
    ...
    @overload
    def LoadAsync(stream: Stream, options: LoadOptions, cancellationToken: CancellationToken) -> Task: ...
    @overload
    def LoadAsync(textReader: TextReader, options: LoadOptions, cancellationToken: CancellationToken) -> Task: ...
    @overload
    def LoadAsync(reader: XmlReader, options: LoadOptions, cancellationToken: CancellationToken) -> Task: ...
    @overload
    ...
    @overload
    def SaveAsync(self, writer: XmlWriter, cancellationToken: CancellationToken) -> Task: ...
    @overload
    def SaveAsync(self, stream: Stream, options: SaveOptions, cancellationToken: CancellationToken) -> Task: ...
    @overload
    def SaveAsync(self, textWriter: TextWriter, options: SaveOptions, cancellationToken: CancellationToken) -> Task: ...
    @Declaration.setter
...
class XNode(XObject):
    ...
    def ReadFromAsync(reader: XmlReader, cancellationToken: CancellationToken) -> Task: ...
    def Remove(self) -> None: ...
    @overload
