...
class EncodedNameValuePair:
    def DecodeName(self) -> ReadOnlyMemory: ...
    def DecodeValue(self) -> ReadOnlyMemory: ...
    @property
    def EncodedName(self) -> ReadOnlyMemory: ...
    @property
    def EncodedValue(self) -> ReadOnlyMemory: ...
...
class FileBufferingWriteStream:
    ...
    @overload
    def DrainBufferAsync(self, destination: PipeWriter, cancellationToken: CancellationToken) -> Task: ...
    def Flush(self) -> None: ...
    @overload
    def FlushAsync(self, cancellationToken: CancellationToken) -> Task: ...
    @property
...
class HttpResponseStreamWriter:
    ...
    @overload
    def Write(self, value: ReadOnlySpan) -> None: ...
    @overload
    ...
    @overload
    def WriteAsync(self, value: ReadOnlyMemory, cancellationToken: CancellationToken) -> Task: ...
    @overload
    def WriteAsync(self, values: Set(Char), index: int, count: int) -> Task: ...
    @overload
    def WriteLine(self, value: ReadOnlySpan) -> None: ...
    @overload
    def WriteLineAsync(self, value: ReadOnlyMemory, cancellationToken: CancellationToken) -> Task: ...
...
class QueryHelpers:
    ...
    @overload
    def AddQueryString(uri: str, queryString: Iterable[KeyValuePair]) -> str: ...
    @overload
    def AddQueryString(uri: str, queryString: Iterable[KeyValuePair]) -> str: ...
    @overload
...
class QueryStringEnumerable:
    @overload
    def __init__(self, queryString: str): ...
    @overload
    def __init__(self, queryString: ReadOnlyMemory): ...
