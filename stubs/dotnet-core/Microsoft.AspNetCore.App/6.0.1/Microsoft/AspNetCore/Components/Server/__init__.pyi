__all__ = ['Circuits','ProtectedBrowserStorage']
...
class CircuitOptions:
    ...
    @property
    def RootComponents(self) -> CircuitRootComponentOptions: ...
...
class CircuitRootComponentOptions:
    def __init__(self): ...
    @property
    def JSComponents(self) -> JSComponentConfigurationStore: ...
    @property
    def MaxJSRootComponents(self) -> int: ...
    @MaxJSRootComponents.setter
    def MaxJSRootComponents(self, value: int) -> None: ...
