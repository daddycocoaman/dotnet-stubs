__all__ = ['Infrastructure','Virtualization']
...
class ErrorBoundary(ErrorBoundaryBase):
    def __init__(self): ...
...
class HeadContent(ComponentBase):
    def __init__(self): ...
    @property
...
class HeadOutlet(ComponentBase):
    def __init__(self): ...


class IErrorBoundaryLogger:
    def LogErrorAsync(self, exception: Exception) -> ValueTask: ...


class IJSComponentConfiguration:
    @property
    def JSComponents(self) -> JSComponentConfigurationStore: ...


class JSComponentConfigurationExtensions:
    @overload
    def RegisterForJavaScript(configuration: IJSComponentConfiguration, identifier: str) -> None: ...
    @overload
    def RegisterForJavaScript(configuration: IJSComponentConfiguration, identifier: str, javaScriptInitializer: str) -> None: ...
    @overload
    def RegisterForJavaScript(configuration: IJSComponentConfiguration, componentType: Type, identifier: str) -> None: ...
    @overload
    def RegisterForJavaScript(configuration: IJSComponentConfiguration, componentType: Type, identifier: str, javaScriptInitializer: str) -> None: ...


class JSComponentConfigurationStore:
    def __init__(self): ...
