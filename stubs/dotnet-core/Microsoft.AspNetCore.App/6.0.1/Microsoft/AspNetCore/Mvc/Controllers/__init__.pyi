...
class ControllerActivatorProvider:
    ...
    def CreateAsyncReleaser(self, descriptor: ControllerActionDescriptor) -> Func`3: ...
...
class IControllerActivator:
    ...
    def ReleaseAsync(self, context: ControllerContext, controller: Object) -> ValueTask: ...
...
class IControllerFactory:
    ...
    def ReleaseControllerAsync(self, context: ControllerContext, controller: Object) -> ValueTask: ...


class IControllerFactoryProvider:
    def CreateAsyncControllerReleaser(self, descriptor: ControllerActionDescriptor) -> Func`3: ...
