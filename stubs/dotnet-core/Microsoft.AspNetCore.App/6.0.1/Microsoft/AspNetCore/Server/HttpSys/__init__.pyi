...
class AuthenticationManager:
    ...
    @property
    def AuthenticationDisplayName(self) -> str: ...
    @property
    def AutomaticAuthentication(self) -> bool: ...
    @property
    def Schemes(self) -> AuthenticationSchemes: ...
    @AllowAnonymous.setter
    def AllowAnonymous(self, value: bool) -> None: ...
    @AuthenticationDisplayName.setter
    def AuthenticationDisplayName(self, value: str) -> None: ...
    @AutomaticAuthentication.setter
    def AutomaticAuthentication(self, value: bool) -> None: ...
    @Schemes.setter
...
class HttpSysOptions:
    ...
    @property
    def UseLatin1RequestHeaders(self) -> bool: ...
    ...
    @UseLatin1RequestHeaders.setter
    def UseLatin1RequestHeaders(self, value: bool) -> None: ...


class IHttpSysRequestDelegationFeature:
    def DelegateRequest(self, destination: DelegationRule) -> None: ...
    @property
    def CanDelegate(self) -> bool: ...
...
class IServerDelegationFeature:
    def CreateDelegationRule(self, queueName: str, urlPrefix: str) -> DelegationRule: ...
