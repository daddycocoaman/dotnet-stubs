...
class BackgroundServiceExceptionBehavior:
    StopHost = 0
    Ignore = 1
...
class HostingHostBuilderExtensions:
    ...
    def ConfigureDefaults(builder: IHostBuilder, args: Set(str)) -> IHostBuilder: ...
    @overload
    def ConfigureHostOptions(hostBuilder: IHostBuilder, configureOptions: Action) -> IHostBuilder: ...
    @overload
    def ConfigureHostOptions(hostBuilder: IHostBuilder, configureOptions: Action) -> IHostBuilder: ...
    @overload
