...
class ResourceManagerStringLocalizer:
    ...
    @overload
    def __init__(self, resourceManager: ResourceManager, resourceAssemblyWrapper: AssemblyWrapper, baseName: str, resourceNamesCache: IResourceNamesCache, logger: ILogger): ...
    @overload
    def __init__(self, resourceManager: ResourceManager, resourceStringProvider: IResourceStringProvider, baseName: str, resourceNamesCache: IResourceNamesCache, logger: ILogger): ...
    @property
