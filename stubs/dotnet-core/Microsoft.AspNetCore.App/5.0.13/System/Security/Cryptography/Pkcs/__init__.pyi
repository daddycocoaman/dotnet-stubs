...
class Rfc3161TimestampRequest(Object):
    ...
    def ProcessResponse(self, source: ReadOnlyMemory) -> Tuple[Rfc3161TimestampToken, int]: ...
...
class Rfc3161TimestampToken(Object):
    ...
    def TryDecode(source: ReadOnlyMemory) -> Tuple[bool, Rfc3161TimestampToken, int]: ...
